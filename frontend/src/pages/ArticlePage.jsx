...
import {
  Calendar, Tag, Eye, ThumbsUp, ThumbsDown,
  Share2, Twitter, Facebook, ArrowLeft
} from 'lucide-react';
...
const ArticlePage = () => {
  ...
  const { data: commentsData } = useQuery({
    ...
    queryFn: () => api.get(`/articles/${data.data._id}/comments`).then((res) => res.data),
  ...
  const commentMutation = useMutation({
    mutationFn: (payload) => api.post(`/articles/${data.data._id}/comments`, payload),
    onSuccess: () => {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex flex-wrap items-center gap-4 py-8 border-t border-b border-pink-100 dark:border-pink-950 mb-12">
        <button
          onClick={() => reactMutation.mutate({ id: article._id, type: 'like' })}
        ...
        <button
          onClick={() => reactMutation.mutate({ id: article._id, type: 'dislike' })}
      ...
      <div className="mb-12">
        ...
        <div className="bg-pink-50 dark:bg-gray-900 rounded-2xl p-6 mb-8">
          ...
          <p className="text-sm text-gray-500 mb-4">
            ...
            <Link to="/subscribe" className="text-pink-500 hover:underline font-semibold">
              Subscribe here
            </Link>
          </p>
          ...
          {replyTo && (
            <div className="flex items-center gap-2 mb-4">
              <span className="text-sm text-gray-500">Replying to a comment</span>
              <button
        ...
        <div className="space-y-6">
          {commentsData?.data?.map((c) => (
            <div key={c._id} className="border-l-2 border-pink-100 dark:border-pink-950 pl-4">
